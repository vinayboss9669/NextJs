...
const About = () => {
    ...
    return (
        <div className={`${geist.className} bg-gradient-to-b from-slate-50 to-white min-h-screen`}>
            <Head>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between">
                        ...
                        <div className="md:w-1/2 flex justify-center">
                            <div className="relative w-64 h-64 md:w-80 md:h-80">
                                <div className="absolute inset-0 bg-gradient-to-br from-purple-500/80 to-blue-500/80 rounded-full animate-pulse-slow"></div>
